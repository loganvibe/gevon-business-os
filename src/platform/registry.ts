...
// ---------------------------- Registry --------------------------------
const MODULES: ModuleManifest[] = [coreModule, inventoryModule, salesModule, expensesModule, peopleModule, workflowModule, commerceModule, enterpriseModule, integrationsModule];
